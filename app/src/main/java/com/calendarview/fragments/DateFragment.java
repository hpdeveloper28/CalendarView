...
public class DateFragment extends Fragment {
    ...
    private CalendarChildAdapter gridAdapter;
    ...
    public CalendarChildAdapter getGridAdapter() {
        return gridAdapter;
    }

    public void setGridAdapter(CalendarChildAdapter gridAdapter) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (gridView == null) {
            LayoutInflater localInflater = CalendarFragment.getThemeInflater(getActivity(),
