package com.calendarview.fragments;
...
import com.calendarview.adapters.CalendarChildAdapter;
import com.calendarview.adapters.MonthAdapter;
import com.calendarview.adapters.WeekAdapter;
import com.calendarview.helper.CaldroidListener;
import com.calendarview.helper.CalendarHelper;
import com.calendarview.infiniteviewpager.InfinitePagerAdapter;
import com.calendarview.infiniteviewpager.InfiniteViewPager;
...
public class CalendarFragment extends DialogFragment {
     ...
     */
    protected ArrayList<CalendarChildAdapter> datePagerAdapters = new ArrayList<CalendarChildAdapter>();
     ...
     */
    public CalendarChildAdapter getNewDatesGridAdapter(int month, int year) {
        return new CalendarChildAdapter(getActivity(), month, year,
     ...
     * provide custom adapter here
     */
    public WeekAdapter getNewWeekdayAdapter(int themeResource) {
     ...
     * @return
     */
    public ArrayList<CalendarChildAdapter> getDatePagerAdapters() {
    ...
    public void refreshView() {
        ...
        for (CalendarChildAdapter adapter : datePagerAdapters) {
            // Reset caldroid data
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        leftArrowButton.getBackground().setColorFilter(getResources().getColor(R.color.today_color), PorterDuff.Mode.MULTIPLY);

        rightArrowButton = (Button) view.findViewById(R.id.calendar_right_arrow);
        rightArrowButton.getBackground().setColorFilter(getResources().getColor(R.color.today_color), PorterDuff.Mode.MULTIPLY);
        ...
        WeekAdapter weekdaysAdapter = getNewWeekdayAdapter(themeResource);
    ...
    private void setupDateGridPages(View view) {
        ...
        // Current month
        CalendarChildAdapter adapter0 = getNewDatesGridAdapter(
        ...
        // when page change
        pageChangeListener.setCalendarChildAdapters(datePagerAdapters);
        ...
        // MonthAdapter actually provides 4 real fragments. The
        // InfinitePagerAdapter only recycles fragment provided by this
        // MonthAdapter
        final MonthAdapter pagerAdapter = new MonthAdapter(
        ...
        for (int i = 0; i < NUMBER_OF_PAGES; i++) {
            DateFragment dateFragment = fragments.get(i);
            CalendarChildAdapter adapter = datePagerAdapters.get(i);
            dateFragment.setGridViewRes(getGridViewRes());
            dateFragment.setGridAdapter(adapter);
            dateFragment.setOnItemClickListener(getDateItemClickListener());
            dateFragment
                    .setOnItemLongClickListener(getDateItemLongClickListener());
        }

        // Setup InfinitePagerAdapter to wrap around MonthAdapter
    ...
    public class DatePageChangeListener implements OnPageChangeListener {
        ...
        private ArrayList<CalendarChildAdapter> calendarChildAdapters;
         ...
         * @return
         */
        public ArrayList<CalendarChildAdapter> getCalendarChildAdapters() {
            return calendarChildAdapters;
        }

        public void setCalendarChildAdapters(
                ArrayList<CalendarChildAdapter> calendarChildAdapters) {
            this.calendarChildAdapters = calendarChildAdapters;
        }
        ...
        public void refreshAdapters(int position) {
            ...
            CalendarChildAdapter currentAdapter = calendarChildAdapters
                    .get(getCurrent(position));
            CalendarChildAdapter prevAdapter = calendarChildAdapters
                    .get(getPrevious(position));
            CalendarChildAdapter nextAdapter = calendarChildAdapters
